        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 pt-6">
              <Link
                href="/contact"
                className="bg-primary-green text-white px-8 py-3.5 rounded-lg font-semibold hover:bg-forest-dark hover:-translate-y-1 transition-all shadow-subtle hover:shadow-elevated inline-flex items-center justify-center gap-2 group"
              >
                Get Export Quote
              ...
              <Link
                href="/products"
                className="border-2 border-primary-green text-primary-green px-8 py-3.5 rounded-lg font-semibold hover:bg-light-bg transition-colors inline-flex items-center justify-center gap-2 group"
              >
                View Products
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </Link>
